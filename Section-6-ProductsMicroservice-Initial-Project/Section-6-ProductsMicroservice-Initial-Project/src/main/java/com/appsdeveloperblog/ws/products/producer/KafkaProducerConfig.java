...
public class KafkaProducerConfig {
    ...
    // Values here override values from application.yml file
...
//        config.put(ProducerConfig.RETRIES_CONFIG, Integer.MAX_VALUE); to enable
...
// I'm not sure that code above ^ is required. Must be checked!!!
...
// --config min.insync.replicas=3 - means will wait ack from min 3 Brockers;
/*
